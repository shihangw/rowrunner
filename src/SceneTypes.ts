...
export interface GeometryBuilder {
  ...
  gradientTriangle(a: Vec3, b: Vec3, c: Vec3, ca: Color, cb: Color, cc: Color): void;
  /** Translucent refractive facet, sorted by depth. Default opacity .55. */
  glassTriangle(a: Vec3, b: Vec3, c: Vec3, color: Color, opacity?: number): void;
  ...
  mountain(x: number, z: number, width: number, height: number, color: Color): void;
...
export type DrawFunction = (geometry: GeometryBuilder, frame: SceneFrame) => void;
