...
} from '../../src/SceneConfigurationCatalog.js';
import { worlds } from '../../examples/src/worlds/ExampleWorlds.ts';
const EXAMPLE_WORLDS = worlds.filter((p) => p.draw);
import { runners } from '../../examples/src/runners/ExampleRunners.ts';
...
export const PALETTES = Object.fromEntries(EXAMPLE_WORLDS.map((w) => [w.id, w.palette]));
